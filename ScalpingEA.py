...
class PaperTradingEngine:
    ...
    def __init__(self, initial_balance: float, config: Dict):
        ...
        self.slippage_points = config.get('slippage_points', 1.0)
...
class ScalpingEAV2:
    ...
    def _log_statistics(self):
        ...
        logger.info(f"Closed Trades: {metrics['total_trades']} | Wins: {metrics['win_trades']} | Losses: {metrics['loss_trades']}")
